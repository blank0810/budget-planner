<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0 z-10">
    ...
    <!-- Responsive Navigation Menu -->
        <div x-show="open" @click.away="open = false" class="sm:hidden space-y-1 pb-2">
        ...
        <div x-show="open" @click.away="open = false" class="sm:hidden pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
