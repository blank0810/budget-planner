...
{{ ... }}
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($existingBudget) {
                return back()
                    ->withInput()
                    ->with('error', 'A budget already exists for this category and period.');
            }
    ...
    public function update(Request $request, Budget $budget)
    {
        ...
        try {
            // Check if another budget exists for this category/month/year (excluding current budget)
            ...
            if ($existingBudget) {
                return back()
                    ->withInput()
                    ->with('error', 'Another budget already exists for this category and period.');
            }
